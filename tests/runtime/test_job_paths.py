...
def test_build_job_paths_and_ensure_dirs(tmp_path) -> None:
    ...
    assert paths.db_path == tmp_path / "jobs" / "cardano.org" / "db" / "cardano.org.sqlite3"
    assert paths.log_path == tmp_path / "jobs" / "cardano.org" / "logs" / "2026-04-13.log"
    assert paths.artifacts_dir == tmp_path / "jobs" / "cardano.org" / "artifacts"
    assert paths.reports_dir == tmp_path / "jobs" / "cardano.org" / "reports"
