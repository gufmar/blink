...
<section class="metrics report-metrics-gap" aria-label="Link-check summary">
  ...
  <div class="metric"><div class="value">{esc(failed_summary.get("failed_total", "—"))}</div><div class="label">Failed</div></div>
  <div class="metric"><div class="value">{esc(failed_summary.get("ignored_total", 0))}</div><div class="label">Ignored</div></div>
